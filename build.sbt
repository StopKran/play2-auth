...
lazy val appPomExtra = {
  <url>https://github.com/zeptolab/play2-auth</url>
    <licenses>
      <license>
    ...
    <scm>
      <url>git@github.com:zeptolab/play2-auth.git</url>
      <connection>scm:git:git@github.com:zeptolab/play2-auth.git</connection>
    </scm>
    <developers>
      <developer>
        <id>gakuzzzz</id>
...
lazy val core = project.in(dir = file("module"))
  .settings(
    baseSettings,
...
//lazy val test = project.in(dir = file("test"))
//  .settings(
//    baseSettings,
...
//  ).dependsOn(core)
//
//lazy val sample = project.in(dir = file("sample"))
...
//
//lazy val social = project.in(dir = file("social"))
//  .settings(
//    baseSettings,
//    name := appName + "-social",
//    libraryDependencies += "com.typesafe.play" %% "play" % playVersion % "provided",
...
//  ).dependsOn(core)
//
//lazy val socialSample = project.in(dir = file("social-sample"))
//  .enablePlugins(play.sbt.PlayScala)
//  .settings(
//    baseSettings,
...
lazy val root = project.in(dir = file("."))
